...
{
    Caption = 'Meta UI Map Layer Element';
    ...
    fields
    {
        ...
        field(12; "Marker Type"; Option)  
        { 
            DataClassification = ToBeClassified;
            OptionMembers = Icon, Circle;
        }
        field(13; Icon; Text[250]) 
        { 
            DataClassification = ToBeClassified;
        }
        field(15; "Marker Fill Color"; Text[100]) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 'red';
        }
        field(18; "Marker Fill Opacity"; Integer) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 1;
        }
        field(20; "Marker Radius"; Integer) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 10;
        }
        field(22; "Marker Stroke Color"; Text[100]) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 'black';
        }
        field(25; "Marker Stroke Opacity"; Integer) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 1;
        }
        field(28; "Marker Stroke With (Pixels)"; Integer) 
        { 
            DataClassification = ToBeClassified;
            InitValue = 3;
        }
        ...
        field(32; Selected; Option)  
        { 
            DataClassification = ToBeClassified;
            OptionMembers = " ", Clicked, Selected;
        }
    }

    keys
    { 
        key(PK; "Route No.", "Stop No.")
        { 
             Clustered = true; 
        } 
    }
    ...
    procedure ShowMarker(): JsonObject
    var
